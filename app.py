...
with st.sidebar:
    ...
    address = st.text_input("Street Address", value="REDACTED-ADDRESS")
    city = st.text_input("City, State", value="REDACTED-CITY")
    zip_code = st.text_input("Zip Code", value="00000") # ✅ Added Zip for better accuracy
...
def get_dynamic_data(addr, cty, zp, radius):
    ...
    geolocator = Nominatim(user_agent="valuation_app")
